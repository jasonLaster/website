...
function Testimonial({testimonial}) {
  ...
  return <div className="py-12 mx-4 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-indigo-900 lg:pr-16">
        ...
        <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
          <div className="relative text-lg font-medium text-white md:flex-grow">
            ...
            <p className="relative" dangerouslySetInnerHTML={{__html: body}}>
            </p>
          </div>
          <footer className="mt-8">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <div className="text-base font-medium text-indigo-200">{title}</div>
              </div>
            </div>
          </footer>
        </blockquote>
